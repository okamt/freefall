...
import io.github.okamt.mage.module.ItemDefinitionWithoutData
...
import io.github.okamt.minestomjam2024.JamGame.breakBlocksAroundPoint
...
object AnvilItem : ItemDefinitionWithoutData() {
    ...
    suspend fun PlayerUseItemEvent.handle() {
